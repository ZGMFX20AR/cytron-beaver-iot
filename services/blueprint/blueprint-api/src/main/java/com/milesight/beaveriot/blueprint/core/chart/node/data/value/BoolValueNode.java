...
@Data
@NoArgsConstructor
public class BoolValueNode extends AbstractValueNode<Boolean> {

  public BoolValueNode(BlueprintNode blueprintNodeParent, String blueprintNodeName, Boolean value) {
